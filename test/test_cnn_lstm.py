...
def test_cnn_lstm(X_test, y_test, path_saved_models, path_results, ap_selection, cnn_lstm_config):
    ...
    for i in range(0, np.shape(X_test)[0]):
        ...
        while model_exist == False:
            ...
            if os.path.exists(path_model_ap):
                ...
                floor_label_encoder = joblib.load(os.path.join(path_model_ap, 'floor_label_encoder.save'))

                building_label_encoder = joblib.load(os.path.join(path_model_ap, 'building_label_encoder.save'))
                ...
                fp_reshaped = data_reshape_sample_timestep_feature(fingerprint.values)
    ...
    logging.info(str(cnn_lstm_config))
